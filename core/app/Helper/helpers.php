...
function float_amount_with_currency_symbol($amount, $text = false)
{
    ...
    $amount = number_format((float)$amount, 2, $decimal_separator, $thousand_separator);
    $return_val = $symbol . $amount;
    ...
    $avg_rating = $count > 0 ? $total_rating/$count : 0;
        ...
        if($project_complete_order_count >= 1 && $avg_rating >=1 ){
            ...
            $string = '<div class="single-project-content-review">
                    ...
                    <a href="javascript:void(0)" class="single-project-orderCompleted">'.__("No Order").' </a>';
        }
    return $string;
}
    ...
    if($header == null){
        if($complete_orders_count >= 1 && $avg_rating >= 1){
            $string = '<div class="jobFilter-proposal-author-contents-review-flex">
                    ...
                    <a href="javascript:void(0)" class="single-project-orderCompleted"> '.$complete_orders_count.' '.__("Orders Completed").'</a>';
        }elseif($avg_rating >= 1){
            $string = '<a href="javascript:void(0)" class="single-project-orderCompleted"> '.$complete_orders_count.' '.__("Orders Completed").'</a>';
        }
        return $string;
    }else{
...
function freelancer_complete_order_count($freelancer_id = null)
{
    ...
    if($order_count >=1){
        $string = '<a href="javascript:void(0)" class="jobFilter-proposal-author-contents-jobs">'.$order_count. ' ' .__("Jobs Completed").' </a>';
    }else{
        $string ='';
    }
    return $string;
...
//    dd($total_order,$total_earnings,$avg_rating);
